...
var AntCascader = (function (_React$Component) {
  ...
  _createClass(AntCascader, [{
    ...
    value: function render() {
      ...
      var pickerCls = (0, _classnames2.default)((_classNames2 = {}, _defineProperty(_classNames2, prefixCls + '-picker', true), _defineProperty(_classNames2, prefixCls + '-picker-disabled', disabled), _classNames2));
